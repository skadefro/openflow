...
export class LoginProvider {
    ...
    static async config(): Promise<any> {
        ...
        const res2 = {
            ...
            loginproviders: await Logger.DBHelper.GetProviders(null),
                ...
                if (req.body && req.body.data) {
                    ...
                    if (req.body.resend) {
                        ...
                        if (exists.length > 0) {
                            ...
                            if (u.email != null && u.email.indexOf("@") > -1) email = u.email;
                            (u as any)._mailcode = NoderedUtil.GetUniqueIdentifier();
                            if(email == null || email.indexOf("@") == -1) {
                                throw new Error("Username is not an email and user object does not have an email address, login not possible");
                            }
